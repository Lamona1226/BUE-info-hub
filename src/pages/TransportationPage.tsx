...
import { Bus, ArrowDownUp, MapPin } from 'lucide-react';
import { PageHeader } from '@/components/PageHeader';
import { FeesModuleNav } from '@/components/FeesModuleNav';
import { Badge } from '@/components/ui/badge';
import { Switch } from '@/components/ui/switch';
import { accommodationTransportCopy, formatEGP, transportationOptions } from '@/data/fees';
...
export const TransportationPage = () => {
  ...
  const sortedOptions = useMemo(() => {
    ...
    return [...transportationOptions].sort((a, b) => a.feePerYear - b.feePerYear);
  }, [sortByPrice]);
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader
        ...
        description="Bus service options with pricing and coverage zones."
      />
      <FeesModuleNav />
